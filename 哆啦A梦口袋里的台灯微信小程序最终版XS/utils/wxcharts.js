...
var config = {
    ...
    titleColor:'#FFB6C1',
    titleFontSize: 20,
  subtitleColor: '#ff7f50',
    subtitleFontSize: 15,
    toolTipPadding: 3,
  toolTipBackground: '#ff7f50',
    toolTipOpacity: 0.7,
...
function drawRadarLabel(angleList, radius, centerPosition, opts, config, context) {
    ...
    context.beginPath();
    context.setFontSize(config.fontSize);
  context.setFillStyle(radarOption.labelColor || '#FFB6C1');
...
function drawYAxisTitle(title, opts, config, context) {
    ...
    context.beginPath();
    context.setFontSize(config.fontSize);
  context.setFillStyle(opts.yAxis.titleFontColor || '#8B0000');
...
function drawXAxis(categories, opts, config, context) {
    ...
    context.beginPath();
  context.setStrokeStyle(opts.xAxis.gridColor || "#F0E68C");
    context.setLineWidth(1);
    ...
    if (config._xAxisTextAngle_ === 0) {
        context.beginPath();
        context.setFontSize(config.fontSize);
      context.setFillStyle(opts.xAxis.fontColor || '#FFB6C1');
        categories.forEach(function (item, index) {
...
function drawYAxis(series, opts, config, context) {
    ...
    context.beginPath();
  context.setStrokeStyle(opts.yAxis.gridColor || "#F0E68C");
    context.setLineWidth(1);
    points.forEach(function (item, index) {
    ...
    context.beginPath();
    context.setFontSize(config.fontSize);
  context.setFillStyle(opts.yAxis.fontColor || '#FFB6C1');
...
function drawLegend(series, opts, config, context) {
    ...
    legendList.forEach(function (itemList, listIndex) {
        ...
        itemList.forEach(function (item) {
            ...
            context.beginPath();
          context.setFillStyle(opts.extra.legendTextColor || '#8B0000');
...
function drawRadarDataPoints(series, opts, config, context) {
    ...
    context.beginPath();
    context.setLineWidth(1);
  context.setStrokeStyle(radarOption.gridColor || "#F0E68C");
